...
const SUMSUB_APP_TOKEN =
  "sbx:nB73rl7IfrYyvcNawKiE9fzo.oZZSnColmYVPBfw8rKGBbBKqH4PjLWKD"; // Example: sbx:uY0CgwELmgUAEyl4hNWxLngb.0WSeQeiYny4WEqmAALEAiK2qTC96fBad - Please don't forget to change when switching to production
const SUMSUB_SECRET_KEY = "P9JsOGygOZuzCBm0MNLLhGuFRY84lJZj"; // Example: Hej2ch71kG2kTd1iIUDZFNsO5C1lh5Gq - Please don't forget to change when switching to production
...
// module.exports = {createAccessToken,getApplicantStatus,addDocument,createApplicant}
